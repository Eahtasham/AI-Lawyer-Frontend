...
export function Sidebar({
  ...
  const sortedSessions = sessions
    .filter(
      (session) =>
        session.isPinned || (session.messages && session.messages.length > 0)
    )
    .sort((a, b) => {
      ...
      <>
        <div
          ...
          <div
            className={cn(
              "p-3",
              isCollapsed && "p-0 my-2 flex justify-center"
            )}>
            {isCollapsed ? (
              <Tooltip>
          ...
          <div
            className={cn(
              "px-3 pb-1",
              isCollapsed && "px-0 pb-1 flex justify-center"
            )}>
            {isCollapsed ? (
              <Tooltip>
                <TooltipTrigger asChild>
          ...
          <div
            ...
            {isCollapsed ? (
              <Tooltip>
                ...
                <TooltipContent side="right">RAG Dashboard</TooltipContent>
              </Tooltip>
            ) : (
              <Link href="/dashboard">
                <Button
                        ...
                        <DropdownMenu
                          ...
                          <DropdownMenuContent
                            ...
                            <DropdownMenuItem
                              ...
                              className="focus:bg-sidebar-accent cursor-pointer">
        ...
        <AlertDialog
          ...
          <AlertDialogContent className="bg-popover border-border text-popover-foreground">
            ...
            <AlertDialogFooter>
              <AlertDialogCancel className="bg-transparent border-border hover:bg-secondary hover:text-secondary-foreground text-popover-foreground">
                Cancel
              </AlertDialogCancel>
              <AlertDialogAction
